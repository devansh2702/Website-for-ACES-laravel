...
<style>
    ...
    .cont{
        ...
        border: 5px dashed rgba(92, 223, 223, 0.986);
    }
    .para{
        text-align: justify;
        font-size:2vw;
    ...
    <body>
    @include('nav')
    <div class="heading">Aces club executives</div>
<div class="cont">
...
<div class="para">For more queries, please visit:</div>
    <br>
    <a href="https://www.instagram.com/aces_it_nu/" class="link">
...
<a href="https://www.facebook.com/aces.itnu/" class="link">
...
<a href="https://www.linkedin.com/company/association-of-computer-engineering-students/mycompany/" class="link">
